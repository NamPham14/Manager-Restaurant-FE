...
export default function CreateOrderModal({
    ...
    function utcToDatetimeLocal(utcString: string | number | Date) {
        const d = new Date(utcString) // JS tự +7 nếu máy ở VN
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" value={utcToDatetimeLocal(formData.reservationTime)} disabled className="w-full border rounded px-3 py-2 bg-gray-100" />
                        </div>
                    </div>
                    <div>
