                  ...
                  <div className="flex flex-col sm:flex-row justify-between text-xs text-gray-500 mt-1 gap-2 break-words">
                    <p>
                      {voucher.minOrderAmount && voucher.minOrderAmount > 0
                        ? `Đơn có thể áp dụng: ${voucher.minOrderAmount.toLocaleString()} VNĐ`
                        : ""}
                    </p>
                    <p>
                      {voucher.maxDiscountAmount &&
                        voucher.maxDiscountAmount > 0
                        ? `Giảm tối đa: ${voucher.maxDiscountAmount.toLocaleString()} VNĐ`
                        : ""}
                    </p>
                  </div>
                    ...
                    voucher.usageLimit !== undefined && (
                      <div className="flex flex-col gap-1 mt-2">
                        <div className="flex justify-between text-xs text-gray-500">
                          <span> {voucher.usageLimit === 0
                            ? ""
                            : `Đã dùng: ${voucher.usedCount}`}</span>
                          <span>
